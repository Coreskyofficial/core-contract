...
contract CoreCardOG is ERC721, AccessControl {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant BURNER_ROLE = keccak256("BURNER_ROLE");

    // mint tokenid = 1
    uint256 private constant TOKEN_INC_INDEX = 0;
    ...
    function mint(
        ...
        require(_tokenId > 0 && _tokenId <= MAX_MINT_QUANTITY_LIMIT, "Quantity overflow 1000.");
        _mint(_to, _tokenId);
    }
